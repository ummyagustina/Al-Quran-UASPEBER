...
import com.example.al_quran_uaspeber.dialogAyat.adapter.AyatAdapter;
...
public abstract class BottomSheetDialogDetailAyat extends BottomSheetDialog implements IViewAyat {
    ...
    @Override
    public void onGetDataAyatt(List<DataAyatItem> data) {
        SetListAyat(data);
    }
